...
Version `0.1.3` adds a professional searchable IANA timezone selector. It includes translated timezone labels with stable internal IDs, language-aware frequent status presets, generic call type examples, editable success/rejection labels, local settings, call registration, CRM copy format, hourly report copy, simple stats, reminders, and a Markdown cheat sheet draft.
